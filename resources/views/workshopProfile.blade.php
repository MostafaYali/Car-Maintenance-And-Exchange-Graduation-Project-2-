				...
				<div class="col-md-8 col-lg-4 m-l-r-auto p-b-30">
					...
					<div class="blo5 pos-relative p-t-60">
						...
						<div class="text-blo5 size34 t-center bo-rad-10 bo7 p-t-90 p-l-35 p-r-35 p-b-30">
							...
							<form method = "POST" action = "{{ route ('workshopimageupdate') }}" enctype = "multipart/form-data">
								@csrf
							...
							<p class="t-center">
									<label class = "text-white">WorkShop Name :</label> <input class="bo-rad-10 sizefull txt10 p-l-20" style="height: 40px; text-align:center;color:white;" type = "text" name = "emailforupdate" value = "{{ $Logged['name'] }}" disabled>
									



									<label class = "text-white">Address :</label> <input class="bo-rad-10 sizefull txt10 p-l-20" style="height: 40px; text-align:center;color:white;" type = "text" name = "emailforupdate" value = "{{ $Logged['address'] }}" disabled>		
									
									<label class = "text-white">Account Type :</label> <input class="bo-rad-10 sizefull txt10 p-l-20" style="height: 40px; text-align:center;color:white;" type = "text" name = "emailforupdate" value = "{{ $Logged['UserType'] }}" disabled>



									<form action = "{{ route('workshopmainaddressupdate') }}" method = "POST">
										@csrf 
                                        ...
                                        <div class="modal-dialog modal-dialog-centered" role="document">
                                          <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                              <input name = "password" style="border-radius: 50px; width: 250px; text-align: center;" type="text" placeholder="Password">
											  		@error('password')
														<label class = "text-warning">{{ $message }}</label>
													@enderror
												<input name = "newaddress" style="border-radius: 50px; width: 250px; text-align: center;" type="text" placeholder="New Address">
                                            </div>
									...
									<br>
									<button type="button" class="btn3 flex-c-m size13 txt11 trans-0-4" data-toggle="modal" data-target="#exampleModalCenter" style="position:absolute; text-align:center; margin-left: 55px;width:50%;">
                                		Update Address
                            		</button>
									<br><br>
									<a class="change" href = "{{ route('workshopupdatepasswordview') }}">Change Password</a>
								</div>
							</div>
