...
<html lang="en">
<head>
	<title>Info For car spare parts</title>
	<meta charset="UTF-8">
...
<div class="card-back">
		...
		<input type="hidden" name="user_name" value="{{ $Logged['logusername'] }}">
				...
				<label style="background-color: transparent; color: white;">
					...
					<select style="width: 90%; border-radius: 10px; height: 55px; text-align: center;" class="select form-control-lg" name="type"> 
						<option>Belts - Filters</option>
						<option>Body Parts</option>
						<option>Braking & Suspension</option>
						<option>Car Glass</option>
                        <option>Enginess & Transmission</option>
                        <option>Half Cuts Cars</option>
                        <option>Headlights</option>
                        <option>Original Rims</option>
                        <option>Salon & Interior Parts</option>
                        <option>Sensor & Electric Parts</option>
                        <option>Other Mechanical Parts</option>
