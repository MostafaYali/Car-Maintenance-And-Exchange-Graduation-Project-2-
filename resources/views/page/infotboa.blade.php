						...
						<ul class="main_menu">
								...
								<li>
									<a href="{{ route('page.categorysell')}}">sells</a>
										...
										<img src = "{{ asset($Logged['image']) }}" style = "height:50px; width:80px; border-radius: 150px 150px 150px 150px"><label>{{ $Logged['name'] }}</label>
...
<div class="card-back">
		...
		<input type="hidden" name="user_name" value="{{ $Logged['logusername'] }}">
				...
				<label style="background-color: transparent; color: white;">
					...
					<select style="width: 90%; border-radius: 10px; height: 55px; text-align: center;" name="type"> 
                        <option>Type</option>
...
<div class="form-group">
				...
				<label style="background-color: transparent; color: white;">
					...
					<div class="wrap-inputemail size12 bo2 bo-rad-10 m-t-3 m-b-23">
						...
						<input style="width: 90%; border-radius: 10px; height: 55px; text-align: center;" class="bo-rad-10 sizefull txt10 p-l-20" type="text" name="brand" value="{{$brandname->man_name}}" readonly>
						@endforeach
					</div>
</div>
...
<div class="form-group">
				<label style="background-color: transparent; color: white;">
					...
					<input type="radio" name="condition" value="new" > <span style='color:white;'>New</span>&nbsp;&nbsp;&nbsp;&nbsp; <input type="radio" name="condition" value="used"><span style='color:white;'>Used</span>
					<br>
					@error('condition')
						<span class="text-warning">{{$message}}</span>
					@enderror
...
<div class="form-group">
				<label style="background-color: transparent; color: white;">
					...
					<div class="wrap-inputemail size12 bo2 bo-rad-10 m-t-3 m-b-23">
						<input style="width: 90%; border-radius: 10px; height: 55px; text-align: center;" class="bo-rad-10 sizefull txt10 p-l-20" type="text" name="location" placeholder="Location">
						<br>
						@error('location')
						<span class="text-warning">{{$message}}</span>
					@enderror
...
<div class="form-group">		
				<label style="background-color: transparent; color: white;">
					...
					<div class="wrap-inputemail size12 bo2 bo-rad-10 m-t-3 m-b-23">
						<input style="width: 90%; border-radius: 10px; height: 55px; text-align: center;" class="bo-rad-10 sizefull txt10 p-l-20" type="text" name="price" placeholder="price">
						<br>
						@error('price')
						<span class="text-warning">{{$message}}</span>
					@enderror
...
<div class="form-group"style="color: white;">
						...
						<input class="btn btn-primary" type="submit" name="submit" style="border-radius: 50px;">
					</div>	
</form>
