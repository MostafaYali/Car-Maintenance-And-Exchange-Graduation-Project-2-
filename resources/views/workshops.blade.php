...
<header>
		...
		<ul class="menu-sidebar p-t-95 p-b-70 bg-dark">
			...
			@if($logged == 'ok')
				...
				@elseif($Logged['UserType'] == "workshop")
					...
					<li class="t-center m-b-13">
						<a href="{{ route('workshopaddpostview')}}" class="a">Add Post</a>
					</li>
				@endif
	...
	<section class="bg-title-page flex-c-m p-t-160 p-b-80 p-l-15 p-r-15">
		<h2 class="tit6 t-center" style="color: yellow;">
			WORKSHOPS Offers
		</h2>
	</section>
	...
	<section>
			...
			@if(Session::get('cannotenter'))
				<div class="alert alert-danger alert-dismissible d-flex align-items-center fade show">
					<i class="fa fa-exclamation-circle"></i>
					<strong class="mx-2">Error!</strong> {{ Session::get('cannotenter') }}
			...
			<div class="row">
					<div class="container t-center">
						...
						<div class="blo4 p-b-63">
							...
							<div style = "color:white;position:relative;right:380px;z">
							<img src = "{{ asset( $post->user->image ) }}" style = "height:50px; width:80px; border-radius: 150px 150px 150px 150px"><h4>{{ $post->user->name }}</h4>
							</div>
								<div class="tit9">
									<h4 class="p-b-16">{{ $post->post_title }}</h4>
								</div>
									<div class="pic-blo4 hov-img-zoom bo-rad-10 pos-relative" style="width:70%;hegiht:30%;margin-left:20%;">
										<a href="#">
											<img src="{{ asset( $post->post_image ) }}" alt="IMG-BLOG" >
										</a>
									</div>


									<h3 style = "color:white;position:relative;right:450px;" >Offer Description :</h3>
								<div class="text-blo4 p-t-33">
									<label style = "color:white;" >{{ $post->post_description }}</label>
								</div>
							@endforeach
						</div>
					</div>
