        ...
        <div class="content-wrapper">
          ...
          <div class="row mb-2">
            <div class="col-lg-12">
              <div class="card">
                <div class="card-body">
                  <form class="forms-sample"action="{{route('store.addads')}}" method="POST"  enctype="multipart/form-data">
                ...
                @endif
                    <div class="form-group">
                        ...
                        @error('photo')
                            ...
                            @enderror
                        <input style="display: none;" id="file" class="form-control p-input"  type = "file" name = "photo" style="color: white;">
                    ...
                    <div class="form-group">
                        ...
                        <input style="border-radius: 10px;" type="text"  name = "title" class="form-control p-input" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Title">
                        @error('title')
                            <span class="text-danger">{{$message}}</span>
                            @enderror
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <input style="border-radius: 10px;" type="text" class="form-control p-input" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Description" name = "describtion">
                        @error('describtion')
                            <span class="text-danger">{{$message}}</span>
                            @enderror
                      </div>
                    ...
                    <div class="form-group">
                      ...
                      <input style="border-radius: 10px;" type="text" class="form-control p-input" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Link" name = "link">
                      @error('link')
                            <span class="text-danger">{{$message}}</span>
                            @enderror
                    </div>
