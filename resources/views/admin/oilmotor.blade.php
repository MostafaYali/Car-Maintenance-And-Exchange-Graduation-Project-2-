        ...
        <div class="content-wrapper">
          ...
          <div class="row mb-2">
            <div class="col-lg-12">
              <div class="card">
                <div class="card-body">
                  <form class="forms-sample"action="{{route('store.oilmotor')}}" method="POST"  enctype="multipart/form-data">
                 @csrf
                ...
                @endif
                    ...
                    <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <input style="border-radius: 10px;" type="email" class="form-control p-input" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Oil Km"  name = "km">
                      ...
                      <div class="form-group">
                        <label for="exampleInputPassword1">Oil viscosity</label>
                        <input style="border-radius: 10px;" type="email" class="form-control p-input" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Oil viscosity" name = "viscosity">
