        ...
        <div class="content-wrapper">
          ...
          <div class="row mb-2">
            <div class="col-lg-12">
              <div class="card">
                <div class="card-body">
                  <form class="forms-sample"action="{{url('brand/update/'.$brands->id)}}" method="POST"  enctype="multipart/form-data">
                 @csrf
                ...
                @endif
                    ...
                    <div class="form-group">
                        <label for="exampleInputPassword1">Enter</label>
                        <input style="border-radius: 10px;" type="text" class="form-control p-input" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Brands"  name = "brand_name" value="{{ $brands->brand }}">
                        @error('brand_name')
