            ...
            <div class="table-responsive">
              ...
              @foreach($users as $user)
                  <tr class="">
                    ...
                    <td>
                      <a href="{{ url('account/view/'.$user->id)}}" class="btn btn-primary btn-sm">view</a>
                  </td>
                    <td>
                    <a href="{{ url('account/edit/'.$user->id)}}" class="btn btn-danger btn-sm" >edit</a>
                  </td>
                  <td>
                    <a href="{{ url('account/delete/'.$user->id)}}" class="btn btn-danger btn-sm">delete</a>
                  </td>
                  </tr>
                  @endforeach
                </tbody>
