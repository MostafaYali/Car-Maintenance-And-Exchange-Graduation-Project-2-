        ...
        <div class="content-wrapper">
          ...
          <div class="row mb-2">
            <div class="col-lg-12">
              <div class="card">
                <div class="card-body">
                <form class="forms-sample"action="{{route('store.belts')}}" method="POST"  enctype="multipart/form-data">
                 @csrf
                ...
                @endif
                    ...
                    <div class="form-group">
                        ...
                        <input style="border-radius: 10px;" type="email" class="form-control p-input" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Brands" name = "brand">
                      ...
                      <div class="form-group">
                        ...
                        <input style="border-radius: 10px;" type="email" class="form-control p-input" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Km" name = "km">
...
<form class="forms-sample"action="{{route('store.tire')}}" method="POST"  enctype="multipart/form-data">
                 @csrf
                <label class = "welcome"></label><br>
                @if(session('success'))
                {{session('success')}}
                @endif
                    ...
                    <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <input style="border-radius: 10px;" type="email" class="form-control p-input" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Models" name = "model">
                      ...
                      <div class="form-group">
                        ...
                        <input style="border-radius: 10px;" type="email" class="form-control p-input" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Size" name = "size">
                    ...
                    <div class="form-group">
                      <input style="background-color: rgb(247, 108, 108);"  type="submit" class="btn" value="save">
                    </div>
                  </form>