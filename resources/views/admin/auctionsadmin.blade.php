              ...
              <table   id="tableData" class="table table-bordered table-striped">
                <thead>
                  <tr class="text-primary">
                    ...
                    <th>Auction Start At</th>
                    <th>Auction End At	Accept AD</th>
                    <th>Reject AD</th>
                  <th>Get AD Details</th>
                  <th>action</th>
                ...
                @foreach($data as $ads)
                  <tr class="">
                    ...
                    <td style="text-align: center; color:black"><button class="btn btn-success" style=" border-radius: 10px;" onclick="window.location.href='{{ url('/auctions/approval/accept')}}/<?php echo $ads->id;?>';" type="submit">Accept</button></td>
                    <td style="text-align: center; color:black"><button class="btn btn-success" style=" border-radius: 10px;" onclick="window.location.href='{{ url('/auctions/delete')}}/<?php echo $ads->id;?>/<?php echo $ads->user_id;?>';" type="submit">Reject</button></td>
                    <td style="text-align: center; color:black"><a class="btn btn-success" style=" border-radius: 10px; color:white;" href="{{ url('/auction/details/approval/')}}/<?php echo $ads->id; ?>">Details</a></td>
