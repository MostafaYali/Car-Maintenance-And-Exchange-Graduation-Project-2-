...
<body class="animsition">
	...
	<section class="section-chef bgwhite p-t-115 p-b-95">
		<section class="vh-100 gradient-custom">
			...
			@endif
		<form action = "{{ url('/auth/user/average/car/data') }}" method = "POST">
			@csrf
			<div>
				<label class = "text-white">Car Manfucturer :</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				<input style="border-radius: 20px; text-align:center; color:white" type = "text" name = "usercar_man" value = "{{$man}}" {{$echo}}><br>
				@error('usercar_man')
					<label class = "text-warning">{{ $message }}</label><br>
				@enderror

				<label class = "text-white">Car Model :</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				<input style="border-radius: 20px; text-align:center; color:white" type = "text" name = "usercar_model" value = "{{$model}}" {{$echo}}>	<br>
				@error('usercar_model')
					<label class = "text-warning">{{ $message }}</label>
				@enderror
				<button type = "submit" class="btn3 flex-c-m size13 txt11 trans-0-4" style="margin-left: 265px;">Save Data</button> 
				...
				<div class="title-section-ourmenu t-center m-b-22">
					<div class="center-wrap" >
						<div class="row">
							<div class="col-12">
								<!-- Item our menu -->
								<div class="item-ourmenu bo-rad-10  pos-relative m-t-30">
									<img src="{{ asset('fontend/images/oil.jpg')}}" alt="IMG-MENU">
	
									<!-- Button2 -->
									<a href="{{ route('AverageForOil') }}" class="btn2 flex-c-m txt5 ab-c-m size7">
										 <h6>oil</h6>
									</a>
								</div>
							</div>
